        ...
        ratingModal.innerHTML = `
            <div class="rating-modal-content">
                ...
                <div class="rating-modal-body">
                    <p>本次服务束，请您对工号【${serviceState.currentAgentId}】的服务进行评价，您的评价对我们非常重要~ 😊</p>
    ...
    const userManager = {
        ...
        register(phone, nickname, password) {
            ...
            const user = {
                ...
                nickname,
                password,
                userId: this.generateUserId(), // 添加随机用户ID
    ...
    function updateUserInterface(user) {
        ...
        authButtons.innerHTML = `
            <span style="color: white; margin-right: 10px;">
                欢迎，${user.nickname}
                <span style="color: white; font-size: 12px; margin-left: 5px;">(ID: ${user.userId || '未知'})</span>
            </span>
            <button class="auth-btn" onclick="handleLogout()">退出</button>
        `;
